...
This repository is for public notes and sanitized experiment records only.

Allowed content:

- competition background and public links
- high-level experiment objectives
- public metric summaries
- sanitized result tables and figures
- data source notes and public schemas
